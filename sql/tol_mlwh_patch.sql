...
ALTER TABLE tol_sample_bioproject CHANGE COLUMN `file` `file` varchar(500) NOT NULL
...
ALTER TABLE tol_sample_bioproject ADD COLUMN platform varchar(40) NOT NULL
COMMENT 'ENA PLATFORM metadata field. Not required if INSTRUMENT is provided' AFTER filename;

ALTER TABLE tol_sample_bioproject ADD COLUMN instrument varchar(40) NOT NULL
COMMENT 'ENA INSTRUMENT metadata field' AFTER platform;

ALTER TABLE tol_sample_bioproject ADD COLUMN library_name varchar(40) NOT NULL
COMMENT 'ENA LIBRARY_NAME metadata field' AFTER instrument;

ALTER TABLE tol_sample_bioproject ADD COLUMN library_source varchar(40) NOT NULL
COMMENT 'ENA LIBRARY_SOURCE metadata field' AFTER library_name;

ALTER TABLE tol_sample_bioproject ADD COLUMN library_selection varchar(40) NOT NULL
COMMENT 'ENA LIBRARY_SELECTION metadata field' AFTER library_source;

ALTER TABLE tol_sample_bioproject ADD COLUMN library_strategy varchar(40) NOT NULL
COMMENT 'ENA LIBRARY_STRATEGY metadata field' AFTER library_selection;

ALTER TABLE tol_sample_bioproject CHANGE COLUMN library_type library_type varchar(40) NOT NULL
...
ALTER TABLE tol_sample_bioproject ADD COLUMN library_construction_protocol varchar(40) NOT NULL
COMMENT 'ENA LIBRARY_CONSTRUCTION_PROTOCOL metadata field' AFTER library_type;

ALTER TABLE tol_sample_bioproject ADD COLUMN design_description varchar(500) NOT NULL
COMMENT 'ENA DESCRIPTION metadata field. Free text description of the library' AFTER library_construction_protocol;

ALTER TABLE tol_sample_bioproject CHANGE COLUMN tolid tolid varchar(40) NOT NULL
COMMENT 'Tree of Life ID, see: https://id.tol.sanger.ac.uk';

ALTER TABLE tol_sample_bioproject ADD COLUMN data_id varchar(128) NOT NULL
