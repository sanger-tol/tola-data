...
CREATE TABLE aliquot (
  ...
  id_lims          varchar(255)   NOT NULL                  COMMENT 'The LIMS system that the aliquot was created in',
  lims_uuid        varchar(255)   NOT NULL                  COMMENT 'The UUID of the aliquot in the LIMS system',
  aliquot_type     varchar(255)   NOT NULL                  COMMENT 'The type of the aliquot',
  source_type      varchar(255)   NOT NULL                  COMMENT 'The type of the source of the aliquot',
  source_barcode   varchar(255)   NOT NULL                  COMMENT 'The barcode of the source of the aliquot',
  sample_name      varchar(255)   NOT NULL                  COMMENT 'The name of the sample that the aliquot was created from',
  used_by_type     varchar(255)   NOT NULL                  COMMENT 'The type of the entity that the aliquot is used by',
  used_by_barcode  varchar(255)   NOT NULL                  COMMENT 'The barcode of the entity that the aliquot is used by',
  volume           decimal(10,2)  NOT NULL                  COMMENT 'The volume of the aliquot (uL)',
  concentration    decimal(10,2)  DEFAULT NULL              COMMENT 'The concentration of the aliquot (ng/ul)',
  created          datetime(6)    NOT NULL                  COMMENT 'The date and time that the aliquot was created',
  last_updated     datetime(6)    NOT NULL                  COMMENT 'The date and time that the aliquot was last updated',
  deleted_at       datetime(6)    DEFAULT NULL              COMMENT 'The date and time that the aliquot was deleted',
  recorded_at      datetime(6)    DEFAULT NULL              COMMENT 'The date and time that the aliquot was recorded',
...
CREATE TABLE cgap_analyte (
  ...
  cgap_analyte_tmp  int unsigned  NOT NULL AUTO_INCREMENT                  COMMENT 'Internal to this database id. Value can change.',
  ...
  passage_number    int           DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=36681152 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


CREATE TABLE cgap_biomaterial (

  cgap_biomaterial_tmp    int unsigned  NOT NULL AUTO_INCREMENT  COMMENT 'Internal to this database id. Value can change.',
...
) ENGINE=InnoDB AUTO_INCREMENT=38860565 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


CREATE TABLE cgap_conjured_labware (

  cgap_conjured_labware_tmp  int unsigned  NOT NULL AUTO_INCREMENT                  COMMENT 'Internal to this database id. Value can change.',
  ...
  KEY project (project)
) ENGINE=InnoDB AUTO_INCREMENT=52646697 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


CREATE TABLE cgap_destruction (

  cgap_destruction_tmp  int unsigned  NOT NULL AUTO_INCREMENT                  COMMENT 'Internal to this database. Value can change.',
  barcode               varchar(32)   NOT NULL,
  cell_line_long_name   varchar(48)   NOT NULL,
  project               varchar(50)   DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=32710534 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


CREATE TABLE cgap_heron (

  cgap_heron_tmp            int unsigned  NOT NULL AUTO_INCREMENT                  COMMENT 'Internal to this database id. Value can change.',
...
) ENGINE=InnoDB AUTO_INCREMENT=21190 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


CREATE TABLE cgap_line_identifier (

  cgap_line_identifier_tmp  int unsigned  NOT NULL AUTO_INCREMENT  COMMENT 'Internal to this database id. Value can change.',
...
) ENGINE=InnoDB AUTO_INCREMENT=60902350 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


CREATE TABLE cgap_organoids_conjured_labware (

  cgap_organoids_conjured_labware_tmp  int unsigned  NOT NULL AUTO_INCREMENT                  COMMENT 'Internal to this database id. Value can change.',
  ...
  KEY conjure_date (conjure_date),
  KEY labware_state (labware_state)
) ENGINE=InnoDB AUTO_INCREMENT=14122724 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


CREATE TABLE cgap_release (

  cgap_release_tmp     int unsigned  NOT NULL AUTO_INCREMENT                  COMMENT 'Internal to this database id. Value can change.',
  barcode              varchar(20)   NOT NULL,
  cell_line_long_name  varchar(48)   NOT NULL,
  cell_line_uuid       varchar(38)   NOT NULL,
  ...
  KEY cell_line_uuid (cell_line_uuid),
  KEY project (project)
) ENGINE=InnoDB AUTO_INCREMENT=144975550 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


CREATE TABLE cgap_supplier_barcode (

  cgap_supplier_barcode_tmp  int unsigned  NOT NULL AUTO_INCREMENT                  COMMENT 'Internal to this database id. Value can change.',
  biomaterial_uuid           varchar(36)   NOT NULL,
  ...
  KEY biomaterial_uuid (biomaterial_uuid)
) ENGINE=InnoDB AUTO_INCREMENT=39890729 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=393724 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


CREATE TABLE gsu_sample_uploads (

  id_gsu_sample_upload_tmp  int unsigned  NOT NULL AUTO_INCREMENT                                COMMENT 'Row ID',
  ...
  id_study_tmp              int unsigned  DEFAULT NULL                                           COMMENT 'Study for this item',
  id_sample_tmp             int unsigned  DEFAULT NULL                                           COMMENT 'Sample info for this item',
  library_name              varchar(40)   DEFAULT NULL                                           COMMENT 'Supplier library name',
  ...
  ena_upload                tinyint(1)    NOT NULL DEFAULT '0'                                   COMMENT 'Identifies if the sample is eligible for ENA upload',
  ...
  CONSTRAINT gsu_su_sample_fk FOREIGN KEY (id_sample_tmp) REFERENCES sample (id_sample_tmp) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT gsu_su_study_fk FOREIGN KEY (id_study_tmp) REFERENCES study (id_study_tmp) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


CREATE TABLE iseq_external_product_components (

  id_iseq_ext_pr_components_tmp  bigint unsigned   NOT NULL AUTO_INCREMENT  COMMENT 'Internal to this database id, value can change',
  ...
  num_components                 tinyint unsigned  NOT NULL                 COMMENT 'Number of component products for this product',
  component_index                tinyint unsigned  NOT NULL                 COMMENT 'Unique component index within all components of this product, a value from 1 to the value of num_components column for this product',
  ...
  CONSTRAINT id_iseq_product_ext_digest_fk FOREIGN KEY (id_iseq_product_ext) REFERENCES iseq_external_product_metrics (id_iseq_product)
...
CREATE TABLE iseq_external_product_metrics (
  ...
  id_iseq_ext_pr_metrics_tmp                        bigint unsigned   NOT NULL AUTO_INCREMENT                                COMMENT 'Internal to this database id, value can change',
  created                                           datetime          DEFAULT CURRENT_TIMESTAMP                              COMMENT 'Datetime this record was created',
  ...
  library_id                                        int               DEFAULT NULL                                           COMMENT 'WSI library identifier',
  ...
  id_run                                            int unsigned      DEFAULT NULL                                           COMMENT 'NPG run identifier, defined where the product corresponds to a single line',
  ...
  min_read_length                                   tinyint unsigned  DEFAULT NULL                                           COMMENT 'Minimum read length observed in the data file',
  target_autosome_coverage_threshold                int unsigned      DEFAULT '15'                                           COMMENT 'Target autosome coverage threshold, defaults to 15',
  ...
  yield_q20                                         bigint unsigned   DEFAULT NULL                                           COMMENT 'Yield in bases at or above Q20 filtered in the same way as the yield column values',
  yield_q30                                         bigint unsigned   DEFAULT NULL                                           COMMENT 'Yield in bases at or above Q30 filtered in the same way as the yield column values',
  num_reads                                         bigint unsigned   DEFAULT NULL                                           COMMENT 'Number of reads filtered in the same way as the yield column values',
  ...
  pre_adapter_min_total_qscore                      tinyint unsigned  DEFAULT NULL                                           COMMENT 'Minimum of TOTAL_QSCORE values in PreAdapter report from CollectSequencingArtifactMetrics',
  ref_bias_min_total_qscore                         tinyint unsigned  DEFAULT NULL                                           COMMENT 'Minimum of TOTAL_QSCORE values in BaitBias report from CollectSequencingArtifactMetrics',
...
CREATE TABLE iseq_flowcell (
  ...
  entity_type                 varchar(30)        CHARACTER SET utf8 NOT NULL  COMMENT 'Lane type: library, library_control, library_indexed, library_indexed_spike',
...
) ENGINE=InnoDB AUTO_INCREMENT=12521057 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE iseq_heron_climb_status (
  ...
  anonymous_sample_id              varchar(15)   DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=5290330 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


CREATE TABLE iseq_heron_product_metrics (

  id_iseq_hrpr_metrics_tmp  bigint unsigned    NOT NULL AUTO_INCREMENT                                COMMENT 'Internal to this database id, value can change',
  created                   datetime           DEFAULT CURRENT_TIMESTAMP                              COMMENT 'Datetime this record was created',
  last_changed              datetime           DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP  COMMENT 'Datetime this record was created or changed',
  id_run                    int unsigned       DEFAULT NULL                                           COMMENT 'Run id',
  ...
  cog_sample_meta           tinyint unsigned   DEFAULT NULL                                           COMMENT 'A Boolean flag to mark sample metadata upload to COG',
  path_root                 varchar(255)       DEFAULT NULL                                           COMMENT 'The uploaded files path root for the entity',
  ivar_md                   smallint unsigned  DEFAULT NULL                                           COMMENT 'ivar minimum depth used in generating the default consensus',
  ...
  ivar_amd                  smallint unsigned  DEFAULT NULL                                           COMMENT 'ivar minimum depth used in generating the additional consensus',
  pct_N_bases_amd           float              DEFAULT NULL                                           COMMENT 'Percent of N bases in the additional consensus',
  longest_no_N_run_amd      smallint unsigned  DEFAULT NULL                                           COMMENT 'Longest data stretch without N in the additional consensus',
...
) ENGINE=InnoDB AUTO_INCREMENT=3102325 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Heron project additional metrics';
...
CREATE TABLE iseq_product_ampliconstats (
  ...
  id_iseq_pr_astats_tmp       bigint unsigned    NOT NULL AUTO_INCREMENT                                COMMENT 'Internal to this database id, value can change',
  created                     datetime           DEFAULT CURRENT_TIMESTAMP                              COMMENT 'Datetime this record was created',
  last_changed                datetime           DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP  COMMENT 'Datetime this record was created or changed',
  id_iseq_product             char(64)           NOT NULL                                               COMMENT 'Product id, a foreign key into iseq_product_metrics table',
  primer_panel                varchar(255)       NOT NULL                                               COMMENT 'A string uniquely identifying the primer panel',
  primer_panel_num_amplicons  smallint unsigned  NOT NULL                                               COMMENT 'Total number of amplicons in the primer panel',
  amplicon_index              smallint unsigned  NOT NULL                                               COMMENT 'Amplicon index (position) in the primer panel, from 1 to the value of primer_panel_num_amplicons',
  ...
  metric_FREADS               int unsigned       DEFAULT NULL                                           COMMENT 'Number of aligned filtered reads',
  ...
  CONSTRAINT iseq_pastats_prm_fk FOREIGN KEY (id_iseq_product) REFERENCES iseq_product_metrics (id_iseq_product)
) ENGINE=InnoDB AUTO_INCREMENT=300588820 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Some of per sample per amplicon metrics generated by samtools ampliconstats';


CREATE TABLE iseq_product_components (

  id_iseq_pr_components_tmp  bigint unsigned   NOT NULL AUTO_INCREMENT  COMMENT 'Internal to this database id, value can change',
  id_iseq_pr_tmp             bigint unsigned   NOT NULL                 COMMENT 'iseq_product_metrics table row id for the product',
  id_iseq_pr_component_tmp   bigint unsigned   NOT NULL                 COMMENT 'iseq_product_metrics table row id for one of this product''s components',
  num_components             tinyint unsigned  NOT NULL                 COMMENT 'Number of component products for this product',
  component_index            tinyint unsigned  NOT NULL                 COMMENT 'Unique component index within all components of this product, \na value from 1 to the value of num_components column for this product',
  ...
  CONSTRAINT iseq_pr_comp_pr_comp_fk FOREIGN KEY (id_iseq_pr_component_tmp) REFERENCES iseq_product_metrics (id_iseq_pr_metrics_tmp),
  CONSTRAINT iseq_pr_comp_pr_fk FOREIGN KEY (id_iseq_pr_tmp) REFERENCES iseq_product_metrics (id_iseq_pr_metrics_tmp) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=10008148 DEFAULT CHARSET=utf8;


CREATE TABLE iseq_product_metrics (

  id_iseq_pr_metrics_tmp                         bigint unsigned       NOT NULL AUTO_INCREMENT                                COMMENT 'Internal to this database id, value can change',
  ...
  id_iseq_flowcell_tmp                           int unsigned          DEFAULT NULL                                           COMMENT 'Flowcell id, see "iseq_flowcell.id_iseq_flowcell_tmp"',
  id_run                                         int unsigned          DEFAULT NULL                                           COMMENT 'NPG run identifier',
  position                                       smallint unsigned     DEFAULT NULL                                           COMMENT 'Flowcell lane number',
  tag_index                                      smallint unsigned     DEFAULT NULL                                           COMMENT 'Tag index, NULL if lane is not a pool',
  iseq_composition_tmp                           varchar(600)          DEFAULT NULL                                           COMMENT 'JSON representation of the composition object, the column might be deleted in future',
  ...
  actual_forward_read_length                     smallint unsigned     DEFAULT NULL                                           COMMENT 'Actual forward read length, bp',
  actual_reverse_read_length                     smallint unsigned     DEFAULT NULL                                           COMMENT 'Actual reverse read length, bp',
  indexing_read_length                           smallint unsigned     DEFAULT NULL                                           COMMENT 'Indexing read length, bp',
  tag_decode_percent                             float(5,2) unsigned   DEFAULT NULL,
  tag_decode_count                               int unsigned          DEFAULT NULL,
  insert_size_quartile1                          smallint unsigned     DEFAULT NULL,
  insert_size_quartile3                          smallint unsigned     DEFAULT NULL,
  insert_size_median                             smallint unsigned     DEFAULT NULL,
  insert_size_num_modes                          smallint unsigned     DEFAULT NULL,
  ...
  q20_yield_kb_forward_read                      int unsigned          DEFAULT NULL,
  q20_yield_kb_reverse_read                      int unsigned          DEFAULT NULL,
  q30_yield_kb_forward_read                      int unsigned          DEFAULT NULL,
  q30_yield_kb_reverse_read                      int unsigned          DEFAULT NULL,
  q40_yield_kb_forward_read                      int unsigned          DEFAULT NULL,
  q40_yield_kb_reverse_read                      int unsigned          DEFAULT NULL,
  ...
  mean_bait_target_coverage                      float                 DEFAULT NULL                                           COMMENT 'Mean coverage of the design target regions of a bait library (if used and known)',
  verify_bam_id_average_depth                    float(11,2) unsigned  DEFAULT NULL,
  verify_bam_id_score                            float(6,5) unsigned   DEFAULT NULL,
  verify_bam_id_snp_count                        int unsigned          DEFAULT NULL,
  ...
  rna_genes_detected                             int unsigned          DEFAULT NULL                                           COMMENT 'Number of genes detected with at least 5 reads.',
  ...
  rna_transcripts_detected                       int unsigned          DEFAULT NULL                                           COMMENT 'Number of transcripts detected with at least 5 reads',
  ...
  target_length                                  bigint unsigned       DEFAULT NULL                                           COMMENT 'The total length of the target regions',
  target_mapped_reads                            bigint unsigned       DEFAULT NULL                                           COMMENT 'The number of mapped reads passing the target filter',
  target_proper_pair_mapped_reads                bigint unsigned       DEFAULT NULL                                           COMMENT 'The number of proper pair mapped reads passing the target filter',
  target_mapped_bases                            bigint unsigned       DEFAULT NULL                                           COMMENT 'The number of mapped bases passing the target filter',
  target_coverage_threshold                      int                   DEFAULT NULL                                           COMMENT 'The coverage threshold used in the target perc target greater than depth calculation',
  ...
  target_autosome_filter                         varchar(30)           DEFAULT NULL                                           COMMENT 'Filter used to produce the autosome target stats file',
  target_autosome_length                         bigint unsigned       DEFAULT NULL                                           COMMENT 'The total length of the autosomes only target regions',
  target_autosome_mapped_bases                   bigint unsigned       DEFAULT NULL                                           COMMENT 'The number of mapped bases passing the autosome target filters',
  target_autosome_coverage_threshold             int                   DEFAULT NULL                                           COMMENT 'The coverage threshold used in the perc target autosome greater than depth calculation',
  ...
  sub_ctoa_art_predicted_level                   tinyint unsigned      DEFAULT NULL                                           COMMENT 'C2A predicted level - 0 = not present, 1 = low, 2 = medium and 3 = high',
  ...
  CONSTRAINT iseq_pr_metrics_flc_fk FOREIGN KEY (id_iseq_flowcell_tmp) REFERENCES iseq_flowcell (id_iseq_flowcell_tmp) ON DELETE SET NULL,
  CONSTRAINT iseq_pr_metrics_lm_fk FOREIGN KEY (id_run, position) REFERENCES iseq_run_lane_metrics (id_run, position) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2109457242 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE iseq_run (
  ...
  rp__read1_number_of_cycles        smallint unsigned  DEFAULT NULL  COMMENT 'Read 1 number of cycles',
  rp__read2_number_of_cycles        smallint unsigned  DEFAULT NULL  COMMENT 'Read 2 number of cycles',
...
CREATE TABLE iseq_run_info (
  ...
  PRIMARY KEY (id_run),
  CONSTRAINT iseq_run_info_ibfk_1 FOREIGN KEY (id_run) REFERENCES iseq_run (id_run)
...
CREATE TABLE iseq_run_lane_metrics (
  ...
  paired_read                       tinyint unsigned       NOT NULL DEFAULT '0',
  cycles                            int unsigned           NOT NULL,
  cancelled                         tinyint unsigned       NOT NULL DEFAULT '0'                                   COMMENT 'Boolen flag to indicate whether the run was cancelled',
  ...
  pf_cluster_count                  bigint unsigned        DEFAULT NULL,
  raw_cluster_count                 bigint unsigned        DEFAULT NULL,
  raw_cluster_density               double(12,3) unsigned  DEFAULT NULL,
  pf_cluster_density                double(12,3) unsigned  DEFAULT NULL,
  pf_bases                          bigint unsigned        DEFAULT NULL,
  q20_yield_kb_forward_read         int unsigned           DEFAULT NULL,
  q20_yield_kb_reverse_read         int unsigned           DEFAULT NULL,
  q30_yield_kb_forward_read         int unsigned           DEFAULT NULL,
  q30_yield_kb_reverse_read         int unsigned           DEFAULT NULL,
  ...
  run_priority                      tinyint                DEFAULT NULL                                           COMMENT 'Sequencing lane level run priority, a result of either manual or default value set by core',
  interop_cluster_count_total       bigint unsigned        DEFAULT NULL                                           COMMENT 'Total cluster count for this lane (derived from Illumina InterOp files)',
  ...
  interop_cluster_count_pf_total    bigint unsigned        DEFAULT NULL                                           COMMENT 'Purity-filtered cluster count for this lane (derived from Illumina InterOp files)',
...
CREATE TABLE iseq_run_status (
  ...
  id_run_status       int unsigned  NOT NULL,
  id_run              int unsigned  NOT NULL   COMMENT 'NPG run identifier',
  `date`              datetime      NOT NULL   COMMENT 'Status timestamp',
  id_run_status_dict  int unsigned  NOT NULL   COMMENT 'Status identifier, see iseq_run_status_dict.id_run_status_dict',
  ...
  CONSTRAINT iseq_run_status_rsd_fk FOREIGN KEY (id_run_status_dict) REFERENCES iseq_run_status_dict (id_run_status_dict)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


CREATE TABLE iseq_run_status_dict (

  id_run_status_dict  int unsigned       NOT NULL,
  `description`       varchar(64)        NOT NULL,
  iscurrent           tinyint unsigned   NOT NULL,
  temporal_index      smallint unsigned  DEFAULT NULL,
...
CREATE TABLE labware_location (
  ...
  id                     bigint        NOT NULL AUTO_INCREMENT,
  labware_barcode        varchar(255)  NOT NULL                  COMMENT 'Barcode on the stored labware',
  location_barcode       varchar(255)  NOT NULL                  COMMENT 'Barcode associated with storage location',
  full_location_address  varchar(255)  NOT NULL                  COMMENT 'Fully qualifed address of the nested location',
  location_name          varchar(255)  NOT NULL DEFAULT ''       COMMENT 'Name of location where labware is stored',
  coordinate_position    int           DEFAULT NULL              COMMENT 'Coordinate position of labware in storage location',
  coordinate_row         int           DEFAULT NULL              COMMENT 'Coordinate row of labware in storage location',
  coordinate_column      int           DEFAULT NULL              COMMENT 'Coordinate column of labware in storage location',
  lims_id                varchar(255)  NOT NULL                  COMMENT 'ID of the storage system this data comes from',
  stored_by              varchar(255)  NOT NULL                  COMMENT 'Username of the person who placed the item there',
  stored_at              datetime(6)   NOT NULL                  COMMENT 'Datetime the item was stored at this location',
  created_at             datetime(6)   NOT NULL,
  updated_at             datetime(6)   NOT NULL,

  PRIMARY KEY (id),
  UNIQUE KEY index_labware_location_on_labware_barcode (labware_barcode),
  KEY index_labware_location_on_location_barcode (location_barcode)
) ENGINE=InnoDB AUTO_INCREMENT=3265797 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


CREATE TABLE labware_location_old (
...
) ENGINE=InnoDB AUTO_INCREMENT=59071187 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


CREATE TABLE long_read_qc_result (

  id_long_read_qc_result_tmp   bigint        NOT NULL AUTO_INCREMENT,
  ...
  KEY index_long_read_qc_result_on_sample_id (sample_id),
  KEY index_long_read_qc_result_on_assay_type_key (assay_type_key)
) ENGINE=InnoDB AUTO_INCREMENT=25830 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=6553 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


CREATE TABLE pac_bio_product_metrics (

  id_pac_bio_pr_metrics_tmp   int                NOT NULL AUTO_INCREMENT,
  id_pac_bio_rw_metrics_tmp   int                NOT NULL                                               COMMENT 'PacBio run well metrics id, see "pac_bio_run_well_metrics.id_pac_bio_rw_metrics_tmp"',
  id_pac_bio_tmp              int                DEFAULT NULL                                           COMMENT 'PacBio run id, see "pac_bio_run.id_pac_bio_tmp"',
  ...
  hifi_read_bases             bigint unsigned    DEFAULT NULL                                           COMMENT 'The number of HiFi bases',
  hifi_num_reads              int unsigned       DEFAULT NULL                                           COMMENT 'The number of HiFi reads',
  hifi_read_length_mean       int unsigned       DEFAULT NULL                                           COMMENT 'The mean HiFi read length',
  barcode_quality_score_mean  smallint unsigned  DEFAULT NULL                                           COMMENT 'The mean barcode HiFi quality score',
  hifi_read_quality_mean      smallint unsigned  DEFAULT NULL                                           COMMENT 'The mean HiFi base quality',
  hifi_bases_percent          float              DEFAULT NULL                                           COMMENT 'The HiFi bases expressed as a percentage of the total HiFi bases',
  last_changed                datetime           DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP  COMMENT 'Date this record was created or changed',
  ...
  CONSTRAINT pac_bio_product_metrics_to_run_fk FOREIGN KEY (id_pac_bio_tmp) REFERENCES pac_bio_run (id_pac_bio_tmp) ON DELETE SET NULL,
  CONSTRAINT pac_bio_product_metrics_to_rwm_fk FOREIGN KEY (id_pac_bio_rw_metrics_tmp) REFERENCES pac_bio_run_well_metrics (id_pac_bio_rw_metrics_tmp) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=31047 DEFAULT CHARSET=utf8 COMMENT='A linking table for the pac_bio_run and pac_bio_run_well_metrics tables with a potential for adding per-product QC data';
...
CREATE TABLE pac_bio_run (
  ...
  plate_number                    int           DEFAULT NULL                                                 COMMENT 'The number of the plate that goes onto the sequencing machine. Necessary as an identifier for multi-plate support.',
  ...
  UNIQUE KEY unique_pac_bio_entry (id_lims,id_pac_bio_run_lims,well_label,comparable_tag_identifier,comparable_tag2_identifier,plate_number),
...
) ENGINE=InnoDB AUTO_INCREMENT=121842 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


CREATE TABLE pac_bio_run_well_metrics (

  id_pac_bio_rw_metrics_tmp             int                  NOT NULL AUTO_INCREMENT,
  id_pac_bio_product                    char(64)             CHARACTER SET utf8 NOT NULL                            COMMENT 'Product id',
  ...
  plate_number                          int                  DEFAULT NULL                                           COMMENT 'The number of the plate that goes onto the Revio sequencing machine. Necessary as an identifier for multi-plate support.',
  ...
  movie_minutes                         smallint unsigned    DEFAULT NULL                                           COMMENT 'Movie time (collection time) in minutes',
  ...
  include_kinetics                      tinyint unsigned     DEFAULT NULL                                           COMMENT 'Include kinetics information where ccs is run',
  hifi_only_reads                       tinyint unsigned     DEFAULT NULL                                           COMMENT 'CCS was run on the instrument and only HiFi reads were included in the export from the instrument',
  heteroduplex_analysis                 tinyint unsigned     DEFAULT NULL                                           COMMENT 'Analysis has been run on the instrument to detect and resolve heteroduplex reads',
  ...
  control_num_reads                     int unsigned         DEFAULT NULL                                           COMMENT 'The number of control reads',
  ...
  control_read_length_mean              int unsigned         DEFAULT NULL                                           COMMENT 'The mean polymerase read length of the control reads',
  ...
  polymerase_read_bases                 bigint unsigned      DEFAULT NULL                                           COMMENT 'Calculated by multiplying the number of productive (P1) ZMWs by the mean polymerase read length',
  polymerase_num_reads                  int unsigned         DEFAULT NULL                                           COMMENT 'The number of polymerase reads',
  polymerase_read_length_mean           int unsigned         DEFAULT NULL                                           COMMENT 'The mean high-quality read length of all polymerase reads',
  polymerase_read_length_n50            int unsigned         DEFAULT NULL                                           COMMENT 'Fifty percent of the trimmed read length of all polymerase reads are longer than this value',
  insert_length_mean                    int unsigned         DEFAULT NULL                                           COMMENT 'The average subread length, considering only the longest subread from each ZMW',
  insert_length_n50                     int unsigned         DEFAULT NULL                                           COMMENT 'Fifty percent of the subreads are longer than this value when considering only the longest subread from each ZMW',
  unique_molecular_bases                bigint unsigned      DEFAULT NULL                                           COMMENT 'The unique molecular yield in bp',
  productive_zmws_num                   int unsigned         DEFAULT NULL                                           COMMENT 'Number of productive ZMWs',
  p0_num                                int unsigned         DEFAULT NULL                                           COMMENT 'Number of empty ZMWs with no high quality read detected',
  p1_num                                int unsigned         DEFAULT NULL                                           COMMENT 'Number of ZMWs with a high quality read detected',
  p2_num                                int unsigned         DEFAULT NULL                                           COMMENT 'Number of other ZMWs, signal detected but no high quality read',
  ...
  hifi_num_reads                        int unsigned         DEFAULT NULL                                           COMMENT 'The number of HiFi reads',
  hifi_read_length_mean                 int unsigned         DEFAULT NULL                                           COMMENT 'The mean HiFi read length',
  hifi_read_quality_median              smallint unsigned    DEFAULT NULL                                           COMMENT 'The median HiFi base quality',
  hifi_number_passes_mean               int unsigned         DEFAULT NULL                                           COMMENT 'The mean number of passes per HiFi read',
  hifi_low_quality_read_bases           bigint unsigned      DEFAULT NULL                                           COMMENT 'The number of HiFi bases filtered due to low quality (<Q20)',
  hifi_low_quality_num_reads            int unsigned         DEFAULT NULL                                           COMMENT 'The number of HiFi reads filtered due to low quality (<Q20)',
  hifi_low_quality_read_length_mean     int unsigned         DEFAULT NULL                                           COMMENT 'The mean length of HiFi reads filtered due to low quality (<Q20)',
  hifi_low_quality_read_quality_median  smallint unsigned    DEFAULT NULL                                           COMMENT 'The median base quality of HiFi bases filtered due to low quality (<Q20)',
  hifi_barcoded_reads                   int unsigned         DEFAULT NULL                                           COMMENT 'Number of reads with an expected barcode in demultiplexed HiFi data',
  hifi_bases_in_barcoded_reads          bigint unsigned      DEFAULT NULL                                           COMMENT 'Number of bases in reads with an expected barcode in demultiplexed HiFi data',
  last_changed                          datetime             DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP  COMMENT 'Date this record was created or changed',

  PRIMARY KEY (id_pac_bio_rw_metrics_tmp),
  UNIQUE KEY pac_bio_rw_metrics_id_product (id_pac_bio_product),
  UNIQUE KEY pac_bio_metrics_run_well (pac_bio_run_name,well_label,plate_number),
...
) ENGINE=InnoDB AUTO_INCREMENT=6807 DEFAULT CHARSET=utf8 COMMENT='Status and run information by well and some basic QC data from SMRT Link';


CREATE TABLE psd_sample_compounds_components (

  id                       bigint    NOT NULL AUTO_INCREMENT,
  compound_id_sample_tmp   int       NOT NULL                  COMMENT 'The warehouse ID of the compound sample in the association.',
  component_id_sample_tmp  int       NOT NULL                  COMMENT 'The warehouse ID of the component sample in the association.',
  last_updated             datetime  NOT NULL                  COMMENT 'Timestamp of last update.',
  recorded_at              datetime  NOT NULL                  COMMENT 'Timestamp of warehouse update.',
...
) ENGINE=InnoDB AUTO_INCREMENT=20726703 DEFAULT CHARSET=latin1;
...
CREATE TABLE sample (
  ...
  priority_level                   varchar(255)  DEFAULT NULL              COMMENT 'Priority level eg Medium, High etc',
...
) ENGINE=InnoDB AUTO_INCREMENT=9520502 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE samples_extraction_activity (
  ...
  CONSTRAINT fk_rails_bbdd0468f0 FOREIGN KEY (id_sample_tmp) REFERENCES sample (id_sample_tmp) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=66922 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE seq_product_irods_locations (
  ...
  id_seq_product_irods_locations_tmp  bigint unsigned  NOT NULL AUTO_INCREMENT                                COMMENT 'Internal to this database id, value can change',
  created                             datetime         DEFAULT CURRENT_TIMESTAMP                              COMMENT 'Datetime this record was created',
  last_changed                        datetime         DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP  COMMENT 'Datetime this record was created or changed',
...
) ENGINE=InnoDB AUTO_INCREMENT=6852254 DEFAULT CHARSET=utf8 COMMENT='Table relating products to their irods locations';
...
) ENGINE=InnoDB AUTO_INCREMENT=9699833 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=7735 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=789845 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


CREATE TABLE tol_sample_bioproject (

  id_tsb_tmp            int unsigned  NOT NULL AUTO_INCREMENT,
  id_sample_tmp         int unsigned  DEFAULT NULL,
  ...
  CONSTRAINT fk_tsb_to_sample FOREIGN KEY (id_sample_tmp) REFERENCES sample (id_sample_tmp) ON DELETE SET NULL ON UPDATE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=9331 DEFAULT CHARSET=utf8;
